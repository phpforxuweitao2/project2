...
@section('title','印象日记后台')
@section('container')
  <div class=" admin-content">
    <div class="daohang">
      <ul>
        <li><a type="button" href="/bk_index" class="am-btn am-btn-default am-btn-xs"> 首页 </a></li>
        <li><a type="button" href="#" class="am-btn am-btn-default am-btn-xs">帮助中心</a></li>
      </ul>
    </div>
